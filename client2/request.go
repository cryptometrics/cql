...
func (req *Request) EndpointArgs() client.EndpointArgs { return req.endpointArgs }
func (req *Request) EndpointStr() string               { return req.endpoint.Get(req.endpointArgs) }
...
func New(conn Connector, method Method, endpoint Endpoint) *Request {
	...
	req.method = method
	req.endpointArgs = make(client.EndpointArgs)
	return req
}
...
func (req *Request) PathParam(key, value string) *Request {
	req.endpointArgs[key] = &client.EndpointArg{PathParam: &value}
	return req
}
...
func (req *Request) QueryParam(key string, value *string) *Request {
	req.endpointArgs[key] = &client.EndpointArg{QueryParam: func() (i *string) {
		if value != nil {
			i = value
		}
		return
