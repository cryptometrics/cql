...
func (cb *coinbase) generateSig(secret, message string) (string, error) {
...
func (cb *coinbase) generageMsg(m Method, endpoint, data, timestamp string) string {
...
func (cb *coinbase) setHeaders(req *http.Request, m Method, endpoint, data string) (e error) {
...
func (cb *coinbase) request(m Method, endpoint string) (*http.Response, error) {
	fullURL := os.Getenv("COINBASE_URL") + endpoint
...
func (cb *coinbase) Connect() error {
	cb.client = http.Client{}
	return nil
}

// Get makes and http GET request, given a an endpoint
func (cb *coinbase) Get(endpoint string) (*http.Response, error) {
