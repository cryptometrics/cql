...
func (currency *CoinbaseMarketDataCurrency) UnmarshalJSON(d []byte) error {
	...
	setter("convertible_to", func(v interface{}) error {
		currency.ConvertibleTo = v.([]string)
		return nil
	})
	...
	setter("processing_time_seconds", func(v interface{}) error {
		currency.ProcessingTimeSeconds = v.(int)
		return nil
	})

	setter("min_withdrawal_amount", func(v interface{}) error {
		currency.MinWithdrawalAmount = v.(int)
		return nil
	})

	setter("max_withdrawal_amount", func(v interface{}) error {
		currency.MaxWithdrawalAmount = v.(int)
		return nil
	})

	err = setter("details", func(v interface{}) error {
		currency.Details = CoinbaseMarketDataCurrencyDetails{}
